...
$mail->Host = 'smtp.elfstudiokzn.ru'; //Set the SMTP server to send through // from readme
$mail->SMTPAuth = true; // from readme
$mail->Username = 'order@elfstudiokzn.ru'; //SMTP username // from readme
$mail->Password = 'elfStudio12345$'; //SMTP password // from readme
$mail->Port = 587; //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`



$mail->setFrom('order@elfstudiokzn.ru');
...
if (trim(!empty($_POST['kidName']))) {
	$body .= '<p><strong>Имя именинника/цы и возраст:</strong> ' . $_POST['kidName'] . '</p>';
}
